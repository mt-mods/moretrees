...
moretrees.coconut_grow_interval = tonumber(stg:get("moretrees.coconut_grow_interval"))
	or 2 * moretrees.coconut_flower_interval * moretrees.coconut_flower_chance
...
moretrees.dates_grow_interval = tonumber(stg:get("moretrees.dates_grow_interval"))
	or 2 * moretrees.dates_flower_interval * moretrees.dates_flower_chance
...
if type(core.get_game_info) == "function" then
	moretrees.enable_planks = core.get_game_info().id ~= "voxelgarden"
else
